...
import { Usage, type LLMEvent } from "@kancode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/SessionProcessor") {}
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("SessionProcessor.create")(function* (input: Input) {
      ...
      const completeToolCall = Effect.fn("SessionProcessor.completeToolCall")(function* (
        ...
        // Spread last so a preserved review wins over a same-named tool metadata key.
        const review = Permission.preserveModuleReview(previous)
